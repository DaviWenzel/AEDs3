...
public class ControleLista {
    ...
    private void handleNovaLista() throws Exception {
        ...
        int idLista = arquivoLista.create(novaLista);
            ...
            switch(opcao) {
                ...
                case 3:
                    if (visaoLista.confirmarExclusaoLista(lista)) {
                        // Remove todas as associações com produtos 
                        arquivoListaProduto.deleteByLista(lista.getId());
    ...
    private void handleGerenciarProdutosLista(Lista lista) throws Exception {
        String opcao;
        do {
            // Usa o índice B+ para buscar produtos da lista
        ...
        do {
            ...
            switch(opcao) {
                case 1:
                    ...
                    break;
                case 2:
                    handleBuscarProdutoPorTermos(lista);
                    break;
                case 3:
    ...
    private void handleBuscarProdutoPorTermos(Lista lista) throws Exception {
        System.out.print("\nDigite os termos para buscar produtos: ");
        Scanner scanner = new Scanner(System.in);
        ...
        if (resultados.isEmpty()) {
            System.out.println("Nenhum produto encontrado para: " + termos);
            return;
        }
        ...
        for (int i = 0; i < resultados.size(); i++) {
            ...
            System.out.println("(" + (i + 1) + ") " + p.getNome() + " - " + p.getGtin13());
        }
        
        System.out.print("\nDigite o número do produto para adicionar (0 para cancelar): ");
        try {
            int escolha = Integer.parseInt(scanner.nextLine());
            if (escolha > 0 && escolha <= resultados.size()) {
                Produto produtoSelecionado = resultados.get(escolha - 1);
    ...
    private void acrescentarProdutoALista(Lista lista, Produto produto) throws Exception {
        // Verificar se o produto já está na lista usando índice B+
